...
# 排除state为United States的这一行
crime2 = crime[crime.state != "United States"]
# 排除state为District of Columbia这一行
...
ax.scatter(list(crime2.murder), list(crime2.burglary),
           s=z, c=z, cmap=cm, linewidth=0.5, alpha=0.5)
# ax.xlabel("murder")
# ax.ylabel("burglary")
...
for i, j, k in zip(crime2.murder, crime2.burglary,
                   state_show):
